...
for i = 1, 9 do
    ...
    --tag_current = awful.screen.focused().selected_tags
	globalkeys = mytable.join(globalkeys,
        -- Toggle tag display.
        awful.key({ modkey,  }, "0",
            function ()
			    ...
			    for i = 1,9 do
                        local tag = screen.tags[i]
							--for _,v in ipairs(tag_current) do
                            --if tag==v then
                                tag.selected = true
                ...
                {description = "toggle tag all", group = "tag"})
            )
	globalkeys = mytable.join(globalkeys,
        -- Toggle tag display.
        awful.key({ modkey, "Control" }, "0",
            function ()
                ...
                {description = "restore tag all", group = "tag"})
            )
--[[
    -- Hack to show all tags 1 and 9 in the shortcut window (mod+s)
	globalkeys = mytable.join(globalkeys,
        -- Toggle tag display.
        awful.key({ modkey,  }, "0",
            function ()
